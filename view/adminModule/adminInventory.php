            ...
            <form method="POST" action="../../controller/inventory.php">
                ...
                <div id="mat_itemDetails" style="display: none;">
                    ...
                    <div class="mb-1">
                        ...
                        <textarea class="form-control" id="mat_part_desc" rows="2" name="part_desc" readonly></textarea>
                    </div>
                    <div class="mb-1">
    ...
    $(document).ready(function () {
        ...
        `;
                ...
                $.each(data, function (index, item) {
                    var rowClass = '';
                    if (parseFloat(item.total_part_qty) === 0) {
                        rowClass = 'text-danger fw-bold'; // Red for zero quantity
                    } else if (parseFloat(item.total_part_qty) < parseFloat(item.min_invent_req)) {
