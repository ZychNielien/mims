...
<head>
    ...
    <style>
        ...
        /* Above 1200px, 2 rows with 5 columns each */
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 1500px;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="p-3" id="materialRegistrationRow">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#btnSubmit").on("click", function (e) {
            ...
            let data = [];
            let valid = true;
            $("#materialRegistrationRow").each(function () {
                let item = {};
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part1">Part Number</label>
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part2">Part Description</label>
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part3">Material Type</label>
                    <select name="new_option" class="form-select" required>                                            
                        <option value="" ${!data.new_option ? 'selected' : ''}>Select Material Type</option>
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part4">Material Category</label>
                    <select name="new_category" class="form-select" required>                                            
                        <option value="" ${!data.new_category ? 'selected' : ''}>Select Material Category</option>
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part5">Cost Center</label>
                <select name="new_cost_center" class="form-select" required>  
                        <option value="" ${!data.new_cost_center ? 'selected' : ''}>Select Cost Center</option>
                        <?php
                        $select_ccid = "SELECT * FROM tbl_ccs";
                        $select_ccid_query = mysqli_query($con, $select_ccid);
                        if (mysqli_num_rows($select_ccid_query) > 0) {
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part6">Location</label>
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part7">Min. Inventory Requirement</label>
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part8">Unit of Measure</label>
                 <select class="form-select" name="new_unit" required>
                      <option value="" ${!data.new_unit ? 'selected' : ''}>Select Unit</option>
                        <?php
                        $select_unit = "SELECT * FROM tbl_unit";
                        $select_unit_query = mysqli_query($con, $select_unit);
                        if (mysqli_num_rows($select_unit_query) > 0) {
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column align-items-center mb-2">
                <label for="part9">Approver</label>
                    <select name="new_approver" class="form-select" required>                                            
                        <option value="" ${!data.new_approver ? 'selected' : ''}>Select Approver</option>
            ...
            <div class="col-12 col-md-6 col-lg-2 d-flex flex-column justify-content-center align-items-center mb-2">
                <button id="part10" class="btn btn-danger form-control" onclick="$(this).closest('.row').parent().remove()">Delete</button>
            </div>
        </div>
        <hr>
    `);
            $("#materialRegistrationRow").append(row);
        }
